...
class Net(nn.Module):
    def __init__(self, dropout_value):
        ...
        self.convblock1A = nn.Sequential(
            nn.Conv2d(in_channels = 3, out_channels = 15, kernel_size = (3, 3), stride = 1, padding = 1, dilation = 2, bias = False),
            nn.ReLU(),
            nn.BatchNorm2d(15),
        ...
        self.convblock2A = nn.Sequential(
            nn.Conv2d(in_channels = 15, out_channels = 30, kernel_size = (3, 3), stride = 1, padding = 1, dilation = 2, bias = False),
            nn.ReLU(),
            nn.BatchNorm2d(30),
            nn.Dropout(dropout_value)
        ) # output_size = 28
        ...
        self.convblock3A = nn.Sequential(
            nn.Conv2d(in_channels = 30, out_channels = 60, kernel_size=(3, 3), stride = 2, padding = 1, dilation = 1, bias = False),
            nn.ReLU(),
            nn.BatchNorm2d(60),
            nn.Dropout(dropout_value)
        ) # output_size = 14
        ...
        self.convblock4A = nn.Sequential(
            nn.Conv2d(in_channels = 60, out_channels = 60, kernel_size=(3, 3), stride = 1, padding = 1, dilation = 1, bias = False),
            nn.ReLU(),
            nn.BatchNorm2d(60),
            nn.Dropout(dropout_value)
        ) # output_size = 14
        ...
        self.convblock1B = nn.Sequential(
            nn.Conv2d(in_channels = 3, out_channels = 15, kernel_size = (3, 3), stride = 1, padding = 0, dilation = 1, bias = False),
            nn.ReLU(),
            nn.BatchNorm2d(15),
            nn.Dropout(dropout_value)
        ) # output_size = 30
        ...
        self.convblock2B = nn.Sequential(
            nn.Conv2d(in_channels = 15, out_channels = 30, kernel_size = (3, 3), stride = 1, padding = 0, dilation = 1, bias = False),
            nn.ReLU(),
            nn.BatchNorm2d(30),
            nn.Dropout(dropout_value)
        ) # output_size = 28
        ...
        self.convblock3B = nn.Sequential(
            nn.Conv2d(in_channels = 30, out_channels = 60, kernel_size=(1, 1), stride = 2, padding = 0, dilation = 1, bias = False),
            nn.ReLU(),
            nn.BatchNorm2d(60),
            nn.Dropout(dropout_value)
        ) # output_size = 14
        ...
        self.convblock4B = nn.Sequential(
            nn.Conv2d(in_channels = 60, out_channels = 60, kernel_size=(1, 1), stride = 1, padding = 0, dilation = 1, bias = False),
            nn.ReLU(),
            nn.BatchNorm2d(60),
            nn.Dropout(dropout_value)
        ) # output_size = 14
        ...
        self.depthwise_separable_block = nn.Sequential(
            nn.Conv2d(in_channels = 120, out_channels = 120, kernel_size = (3, 3), padding = 0, groups = 120, bias = False),
            nn.Conv2d(in_channels = 120, out_channels = 60, kernel_size = (1, 1), padding = 0, bias = False),
            nn.ReLU(),
            nn.BatchNorm2d(60),
            nn.Dropout(dropout_value)
        ) ## output_size = 12
